  ...
  return (
    <div className="wrapper__full">
      <div className="plan">
              ...
              <div className="accordion__card">
                <div className="accordion__header" onClick={() => toggleAccordion(0)}>
                  ...
                  <svg
                    ...
                    strokeWidth="0"
                    viewBox="0 0 16 16"
                    className={`accordion__icon ${accordionOpen === 0 ? 'accordion__icon--rotate' : ''}`}
                    height="1em"
                    width="1em"
                    xmlns="http://www.w3.org/2000/svg"
                  >
                ...
                <div className={`collapse ${accordionOpen === 0 ? 'show' : ''}`} style={accordionOpen === 0 ? { maxHeight: '200px' } : { maxHeight: '0px' }}>
               ...
               <div className="accordion__card">
                <div className="accordion__header" onClick={() => toggleAccordion(1)}>
                  ...
                  <svg
                    ...
                    strokeWidth="0"
                    viewBox="0 0 16 16"
                    className={`accordion__icon ${accordionOpen === 1 ? 'accordion__icon--rotate' : ''}`}
                    height="1em"
                    width="1em"
                    xmlns="http://www.w3.org/2000/svg"
                  >
                ...
                <div className={`collapse ${accordionOpen === 1 ? 'show' : ''}`} style={accordionOpen === 1 ? { maxHeight: '200px' } : { maxHeight: '0px' }}>
                  <div className="accordion__body">
              ...
              <div className="accordion__card">
                <div className="accordion__header" onClick={() => toggleAccordion(2)}>
                  ...
                  <svg
                    ...
                    strokeWidth="0"
                    viewBox="0 0 16 16"
                    className={`accordion__icon ${accordionOpen === 2 ? 'accordion__icon--rotate' : ''}`}
                    height="1em"
                    width="1em"
                    xmlns="http://www.w3.org/2000/svg"
                  >
                ...
                <div className={`collapse ${accordionOpen === 2 ? 'show' : ''}`} style={accordionOpen === 2 ? { maxHeight: '200px' } : { maxHeight: '0px' }}>
                  <div className="accordion__body">
              ...
              <div className="accordion__card">
                <div className="accordion__header" onClick={() => toggleAccordion(3)}>
                  ...
                  <svg
                    ...
                    strokeWidth="0"
                    viewBox="0 0 16 16"
                    className={`accordion__icon ${accordionOpen === 3 ? 'accordion__icon--rotate' : ''}`}
                    height="1em"
                    width="1em"
                    xmlns="http://www.w3.org/2000/svg"
                  >
                ...
                <div className={`collapse ${accordionOpen === 3 ? 'show' : ''}`} style={accordionOpen === 3 ? { maxHeight: '200px' } : { maxHeight: '0px' }}>
                  <div className="accordion__body">
        ...
        {/* Footer section from provided HTML (simplified for React) */}
        <section id="footer">
          <div className="container">
            <div className="row">
